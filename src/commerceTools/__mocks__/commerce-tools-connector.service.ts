...
interface MockedCommerceToolsConectorService
  ...
  __simulateGetClient: (products?: any) => MockedCommerceToolsConectorService;
}
...
commerceToolsConnectoService.__simulateGetClient = (products: any = {}) => {
  let prods: any = {
    body: {
      results: [
        {
