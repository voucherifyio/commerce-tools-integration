...
export const cart = {
  ...
  version: 312,
  versionModifiedAt: '2023-05-05T09:23:59.766Z',
  lastMessageSequenceNumber: 1,
  createdAt: '2023-05-04T12:58:58.689Z',
  lastModifiedAt: '2023-05-05T09:23:59.766Z',
  lastModifiedBy: {
  ...
  custom: {
    ...
    fields: {
      couponsLimit: 5,
      discount_codes: [
        '{"status":"AVAILABLE","value":19305,"banner":"5% off for new customers","code":"promo_J3cOJqbnZydJs6M7hOAwVckS","type":"promotion_tier"}',
