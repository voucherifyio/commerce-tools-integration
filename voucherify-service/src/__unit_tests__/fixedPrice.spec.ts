import { replaceCodesWithInapplicableCoupons } from '../integration/utils/replaceCodesWithInapplicableCoupons';
import mapValidateCouponsResultToLineProductsWithFixedAmount from '../commercetools/store-actions/cart-update-actions/helpers/fixedPrice';
